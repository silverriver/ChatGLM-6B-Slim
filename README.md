...
## 更新信息
**[2023/03/23]** 增加API部署（感谢 [@LemonQu-GIT](https://github.com/LemonQu-GIT)）。增加Embedding量化模型[ChatGLM-6B-INT4-QE-Slim](https://huggingface.co/silver/chatglm-6b-int4-slim)。增加对基于Apple Silicon的Mac上GPU加速的支持。

**[2023/03/19]** 增加流式输出接口 `stream_chat`，已更新到网页版和命令行 Demo。修复输出中的中文标点。增加量化后的模型 [ChatGLM-6B-INT4Slim](https://huggingface.co/silver/chatglm-6b-int4-slim)
